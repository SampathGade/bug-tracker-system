...
public class UserController {
    ...
    @PostMapping("/getDevelopersByProject")
    public ResponseEntity<?> getDevelopersByProject(@RequestBody String name){
        try {
            List<String> developers = userService.getDevelopersByProject(name);
